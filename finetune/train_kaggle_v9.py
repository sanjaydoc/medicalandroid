# =============================================================================
# MedDroid v9 — STYLE-ONLY QLoRA fine-tune of MedGemma 4B on Kaggle
# =============================================================================
...
sh("curl -L -o build_dataset_v9.py https://raw.githubusercontent.com/sanjaydoc/medicalandroid/main/finetune/build_dataset_v9.py")
...
sh(f"{sys.executable} build_dataset_v9.py")
...
DONE (v9 — style only). Next:
  ...
  - Benchmark: set MEDGEMMA_MODEL=meddroid-v9 and run benchmark_medical.py.
